import {
  EditListingReq,
  EditListingRes,
} from "@/models/dto/listings/EditListing";
...
import { postEditListing } from "@/repo/listings";
...
const resolver = classValidatorResolver(EditListingReq);
...
export default function EditListing() {
  ...
  const {
    ...
    isLoading,
    mutate: editListing,
  } = useMutation<EditListingRes, Error, EditListingReq>({
    mutationKey: ["postEditListing", router.query.uid],
    mutationFn: postEditListing,
  });
  ...
  return (
    <>
      ...
      <form
        onSubmit={handleSubmit((d) => editListing(d))}
